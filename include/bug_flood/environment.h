...
public:
  ...
  bool getObstacleIntersection(Point start, Point end, Point &intersection,
                               double &distance, int &boundaryID,
                               Point &location);
  bool getObstacleIntersection(Line line, Point &intersection, double &distance,
...
private:
  ...
  vector<VisitInfo> visited; // A global point set to keep track of what's
                             // visited and what's not
