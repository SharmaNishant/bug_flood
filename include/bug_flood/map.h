...
/***
 * NEVER GIVE THE POINTER OF THE map / visited MEMBER VARIABLE TO ANYONE ELSE.
 * OTHERWISE BRACE SEGFAULTS. SOL: IMPLEMENT A COPY CONSTRUCTOR FOR PASSING THE
 * OBJECT If We want to give someone a getMAP function we need to do it without
 * giving out the pointer. Current implementation will return a vector of
 * locations (bottom left) of a 1x1 square of the map with rowSize and col size
 * as referenced variables.
 */
class Map {
public:
  /*
