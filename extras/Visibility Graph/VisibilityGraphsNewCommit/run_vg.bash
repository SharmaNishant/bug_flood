...
base="/home/shivamthukral/test_ws/src/bug_flood/obstacles"
outputFolderName="/result"

source /home/nishant/catkin_ws/devel_isolated/setup.bash

files=($(find $base -type d -name "*_obstacles"))
for folder in ${files[*]}
do
   echo $folder 
   for i in {1..100}
    ...
    # /home/shivamthukral/bug_flood_ws/src/bug_flood/extras/Visibility Graph/VisibilityGraphsNewCommit/build/Debug $bm_file $sg_file >> $result_file
    done
done
