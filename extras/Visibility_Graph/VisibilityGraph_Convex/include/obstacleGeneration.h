...
vector<string> getConvexObstacles(char *fileName) {
    ...
    while(std::getline(fin, line1))
    {
        ...
        string str="polygon(("+splitted[1]+" "+splitted[0]+","+splitted[3]+" "+splitted[2]+","+splitted[5]+" "+splitted[4]
                   +","+splitted[7]+" "+splitted[6]+","+splitted[9]+" "+splitted[8]+"))";
        //cout<<str<<endl;
        obs.push_back(str);
    }
    return obs;
